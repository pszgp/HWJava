...
d3.csv("devices_mock.csv", function(data) {
  ...
  var deviceip0 = 0,
      deviceip1 = d3.max(data, function(d) { return d.deviceip; }),
      year0 = d3.min(data, function(d) { return d.year; }),
      year1 = d3.max(data, function(d) { return d.year; }),
      year = year1;

  // Update the scale domains.
  x.domain([0, deviceip1 + 5]);
  y.domain([0, d3.max(data, function(d) { return d.nbytes; })]);
  ...
  var years = body.selectAll("g")
      .data(d3.range(year0 - deviceip1, year1 + 5, 5))
    .enter().append("g")
  ...
  data = d3.nest()
      ...
      .key(function(d) { return d.year - d.deviceip; })
      .rollup(function(v) { return v.map(function(d) { return d.nbytes; }); })
      .map(data);
